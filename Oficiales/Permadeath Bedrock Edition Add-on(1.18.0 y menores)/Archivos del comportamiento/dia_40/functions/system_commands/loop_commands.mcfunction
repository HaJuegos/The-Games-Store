...
replaceitem entity @e[type=zombie_pigman,family=arrow] slot.weapon.mainhand 1 arrow 1 25 
...
execute @s[scores={totem=97..100}] ~ ~ ~ tag @s add muerete
kill @s[tag=!prem,scores={totem=97..100}]
kill @s[tag=muerete,tag=!prem,scores={totem=97..100}]