...
execute @s[tag=!muerto,name=!"ha juegos",name=!"NormanliumZz",name=!"SrJanterzZzZ",name=!"Actucutel YT",name=!"Maxi107337",name=!"PatoMcfly5173",name=!"Ken2437",name=!"DelachitUwU",name=!"RIDER2576168",name=!"Astral302302",name=!"Kevin294GG",name=!"REALITI KUN",name=!"ApexPrdtrMx",name=!"IOP-I-Skuartu",name=!"HasvokMC7",name=!"KidAxolotl",name=!"MeryNieves0",name=!"AbdielSL8706"] ~ ~ ~ structure load heads:cabezamuerto ~ ~-1 ~
execute @s[tag=!muerto,name="ha juegos"] ~ ~ ~ structure load heads:cabezamuertoha ~ ~-1 ~
execute @s[tag=!muerto,name="NormanliumZz"] ~ ~ ~ structure load heads:cabezamuertono ~ ~-1 ~
execute @s[tag=!muerto,name="SrJanterzZzZ"] ~ ~ ~ structure load heads:cabezamuertojanter ~ ~-1 ~
execute @s[tag=!muerto,name="Actucutel YT"] ~ ~ ~ structure load heads:cabezamuertoactu ~ ~-1 ~
execute @s[tag=!muerto,name="Maxi107337"] ~ ~ ~ structure load heads:cabezamuertomaxi ~ ~-1 ~
execute @s[tag=!muerto,name="Ken2437"] ~ ~ ~ structure load heads:cabezamuertoken ~ ~-1 ~
execute @s[tag=!muerto,name="PatoMcfly5173"] ~ ~ ~ structure load heads:cabezamuertopato ~ ~-1 ~
execute @s[tag=!muerto,name="DelachitUwU"] ~ ~ ~ structure load heads:cabezamuertodela ~ ~-1 ~
execute @s[tag=!muerto,name="RIDER2576168"] ~ ~ ~ structure load heads:cabezamuertorider ~ ~-1 ~
execute @s[tag=!muerto,name="Astral302302"] ~ ~ ~ structure load heads:cabezamuertoastral ~ ~-1 ~
execute @s[tag=!muerto,name="Kevin294GG"] ~ ~ ~ structure load heads:cabezamuertokevin ~ ~-1 ~
execute @s[tag=!muerto,name="REALITI KUN"] ~ ~ ~ structure load heads:cabezamuertorealiti ~ ~-1 ~
execute @s[tag=!muerto,name="ApexPrdtrMx"] ~ ~ ~ structure load heads:cabezamuertoapex ~ ~-1 ~
execute @s[tag=!muerto,name="IOP-I-Skuartu"] ~ ~ ~ structure load heads:cabezamuertoskuartu ~ ~-1 ~
execute @s[tag=!muerto,name="HasvokMC7"] ~ ~ ~ structure load heads:cabezamuertomathew ~ ~-1 ~
execute @s[tag=!muerto,name="KidAxolotl"] ~ ~ ~ structure load heads:cabezamuertoaxol ~ ~-1 ~
execute @s[tag=!muerto,name="MeryNieves0"] ~ ~ ~ structure load heads:cabezamuertomery ~ ~-1 ~
execute @s[tag=!muerto,name="AbdielSL8706"] ~ ~ ~ structure load heads:cabezamuertoabdiel ~ ~-1 ~
