...
execute @s[tag=!dia40] ~ ~ ~ scoreboard objectives add "lluvia_c" dummy "lluvia_c"
execute @s[tag=!dia40] ~ ~ ~ tellraw @s {"rawtext": [{"text":"§6Estas en el §9§lDia 40."}]}
tag @s[tag=!intro] add intro
tag @s[tag=!dia40] add dia40